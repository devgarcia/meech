...
class ComponentsTest < ApplicationSystemTestCase
  ...
  test "creating a Component" do
    ...
    fill_in "Order code", with: @component.order_code
    fill_in "Quantity", with: @component.quantity
    fill_in "Size", with: @component.size
    fill_in "Supplier", with: @component.supplier
    fill_in "Termination mounting style", with: @component.termination_mounting_style
